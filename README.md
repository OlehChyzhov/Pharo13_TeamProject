...
### Члени команди
- Олег Чижов – Розробив клас “Фруктове дерево” та написав тести до нього, переглянув класи, створені іншими учасниками команди і виправив зауваження, отримані під час презентації програми, презентував програму

- Тимочко Юлія - Повністю реалізувала контейнер і тести для нього. Повнісню реалізувала SpTreeSystemPresenter

- Пономарьова Валерія - Реалізувала різновиди дерев (Яблуко та Абрикос) і тести для них, додала приклад використання програми (<script>) у TreeContainer
